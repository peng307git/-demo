<div class="nav clearfix">
    <ul>
        <li  class="active"  ><a href="/"><@spring.messageText "index.header.text2" "首页"/></a></li>
        ...
        <li id="reports" <#if nav_page=='notice'> class="active"</#if>><a href="/reports/newses/"><@spring.messageText "reports.nav" "生态动态"/><#if (unReadNoticeNum > 0)><i></i></#if></a>
            <div class="navigation_bar">
