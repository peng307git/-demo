...
<link rel="stylesheet" type="text/css"
      href="/static/css/plugin/flexslider.css">
<link rel="stylesheet" type="text/css" href="/static/v6/css/styles-index.css">
</#macro>
<#macro body>
<#assign nav_page="index" >
<!--[if IE]>
    <div class="iealert"><P>为使您获得更好的体验，推荐使用谷歌浏览器 或 火狐浏览器。<a class="chrome" href="http://www.chromeliulanqi.com/" target="_blank">谷歌</a> <a class="firefox"  href="http://www.firefox.com.cn/" target="_blank">火狐</a><i id="closeIeAlert">X</i></p></div>
<![endif]-->
            ...
            <div class="container">
                ...
                <#else>
                    ...
                    <div class="topbar-price">
                        <span class="underline"><@spring.messageText "index.new.text1" "最新"/> BTC <@spring.messageText "index.new.text2" "价格"/> : </span>
                        <span class='new-btc-price'></span><i>|</i>
                        <span class="underline"><@spring.messageText "index.new.text1" "最新"/> MG <@spring.messageText "index.new.text2" "价格"/> : </span>
...
<section class="product-section">
    <div class="header3"><h3><i class="iconfont icon-liujiaoxing"></i><@spring.messageText "index.new.text3" "智慧生态"/></h3></div>
...
<section class="memorabilia" id="memorabilia">
    <div class="header3"><h3><i class="iconfont icon-liujiaoxing"></i><@spring.messageText "index.new.text34" "大事记"/></h3></div>
...
<!-- 添加温馨提示 -->
<div id="alert_status" style="width:600px; position: fixed;z-index: 999; left:35%; top: 15%; background: #fff; text-align: center;padding:0 40px 20px 40px;font-size: 16px; box-shadow: #666 0 0 3px; display:none;">
...
require(['static/v6/js/page/index']);
</script>
