var cityJson = [
    ...
    {"item_code":"411800","item_name":"省直辖县"},
    ...
    {"item_code":"422900","item_name":"省直辖县"},
    ...
    {"item_code":"469000","item_name":"省直辖县"},
    ...
    {"item_code":"659000","item_name":"省直辖县"},
    ...
    {"item_code":"341302","item_name":"墉桥区"},
    ...
    {"item_code":"410304","item_name":"廛河回族区"},
    ...
    {"item_code":"411502","item_name":"师河区"},
    ...
    {"item_code":"411801","item_name":"济源市"},
    ...
    {"item_code":"420505","item_name":"虎亭区"},
    ...
    {"item_code":"422901","item_name":"仙桃市"},
    {"item_code":"422902","item_name":"潜江市"},
    {"item_code":"422903","item_name":"天门市"},
    {"item_code":"422904","item_name":"神农架林区"},
    ...
    {"item_code":"441901","item_name":"莞城区"},
    {"item_code":"441902","item_name":"常平镇"},
    {"item_code":"441903","item_name":"塘厦镇"},
    {"item_code":"441904","item_name":"万江区"},
    {"item_code":"441905","item_name":"虎门镇"},
    {"item_code":"442001","item_name":"中山市"},
    ...
    {"item_code":"659005","item_name":"北屯市"},
    {"item_code":"659006","item_name":"铁门关市"},
    {"item_code":"659007","item_name":"双河市"},
    {"item_code":"659008","item_name":"可克达拉市"}
]

function citychange(choosePro){
    ...
    choosePro.find("#choosePro").after(sb.toString());
} 
// 省值变化时 处理市
function doProvAndCityRelation() {
    var province = $(document).find(".china .sheng");
    var city = $(document).find(".china .shi");
    var county = $(document).find(".china .diqu");
    ...
    if (city.find("#chooseCity").length === 0) {
        city.append("<option id='chooseCity' value='-1'>请选择您所在城市</option>");
    }
    if (county.find("#chooseCounty").length === 0) {
    ...
    //console.log("doProvAndCityRelation"+sb.toString());
    city.find("#chooseCity").after(sb.toString());
} 
// 市值变化时 处理区/县
function doCityAndCountyRelation() {
    ...
    county.find("#chooseCounty").after(sb.toString());
